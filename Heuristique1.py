    ...
    for c in comb:
        for f in c :
            ...
            if f[0]  not in default_values and  f[1] not in default_values:
                values=Game.swap(values,f[0],f[1],increment="inc")
                ...
                if  conflits<conflit_actuel :
                    ...
                    values=Game.swap(values,f[0],f[1],increment="dec")
...
def heuristique(values,valeur_par_defaut):
    ...
    values,conflits=combinison_possible(values,valeur_par_defaut,conflit)
